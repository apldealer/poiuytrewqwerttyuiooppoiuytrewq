...
document.addEventListener('DOMContentLoaded', (event) => {
  const disabledBox = document.querySelector('.boxes a[href="airpods1.html"]').closest('.boxes');
  disabledBox.classList.add('enabled');
});

document.addEventListener('DOMContentLoaded', (event) => {
  const disabledBox = document.querySelector('.boxes a[href="airpods2.html"]').closest('.boxes');
  disabledBox.classList.add('enabled');
});

    document.addEventListener('DOMContentLoaded', (event) => {
  const disabledBox = document.querySelector('.boxes a[href="airpods3.html"]').closest('.boxes');
  disabledBox.classList.add('enabled');
});
